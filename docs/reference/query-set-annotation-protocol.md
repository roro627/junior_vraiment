...
**Version :** `query-relevance-llm-a-1.0.0`  
...
```json
{
  ...
  "primaryFamily": "frontend | backend | fullstack | mobile | data | devops-cloud | cybersecurity | qa-test | other-tech | non-tech | unclear",
